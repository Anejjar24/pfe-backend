...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: '2026-05-06T00:00:00Z', description: 'Range start (ISO 8601). Default: 24 h ago' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
], SensorStatsQueryDto.prototype, "from", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: '2026-05-13T00:00:00Z', description: 'Range end (ISO 8601). Default: now' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: HistoryGranularity, default: HistoryGranularity.HOUR, description: 'Bucket size for aggregation' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(HistoryGranularity),
    __metadata("design:type", String)
], StationHistoryQueryDto.prototype, "granularity", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: '2026-05-06T00:00:00Z', description: 'Range start (ISO 8601)' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
], StationHistoryQueryDto.prototype, "from", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: '2026-05-13T00:00:00Z', description: 'Range end (ISO 8601)' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
