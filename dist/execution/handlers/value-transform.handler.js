...
exports.ValueTransformHandler = void 0;
const CONV = {
...
class ValueTransformHandler {
    ...
    round(node, value) {
        ...
        const rounded = mode === 'floor' ? Math.floor(value * factor) / factor :
    ...
    map(node, value) {
        ...
        if (label === undefined)
            return { value, label: null, branch: 'unknown' };
...
exports.ValueTransformHandler = ValueTransformHandler;
//# sourceMappingURL=value-transform.handler.js.map